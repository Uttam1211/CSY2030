    ...
    private void createCompetitorList(String filePath) {
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                EgameCompetitor competitor;
                competitor = new EgameCompetitor(competitorNumber, competitorName, level, country, scores);
...
//System.out.println(competitorList.getCompetitor(10).getOverallScore());
    ...
    public void produceFinalReport(String filePath) {
        try {
            ...
            writer.write(" ------- part2.Reports --------");
            writer.newLine();
            writer.write(" ------- part2.Short Details of all Competitors  --------");
            writer.newLine();
            for (EgameCompetitor competitor : competitorList.getCompetitorList()) {
                writer.write(competitor.getShortDetails());
                writer.newLine();
                writer.write(" ----------------------------------------");
                writer.newLine();
            }
            ...
            writer.newLine();
            writer.write(" ------- part2.Competitors details with statistics --------");
