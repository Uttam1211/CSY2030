...
public class EgameCompetitor extends CompetitorList {
    ...
    public String getFullDetails() {
        ...
        return "Competitor number " + competitorNumber + ", name " + competitorName.getFullName() + ", " + "aged "+competitorName.getAge() + ". " +
    ...
    public void updateScore(int newScore) {
        // update the scores array to include the new score
